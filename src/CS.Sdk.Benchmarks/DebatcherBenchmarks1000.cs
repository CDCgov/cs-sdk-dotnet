...
namespace CS.Sdk.Benchmarks
{
    ...
    [RankColumn]
    public class DebatcherBenchmarks1000
    {
        ...
        [Benchmark]
        public void BenchmarkSpanDebatcher1000()
        {
            StringDebatchHandler handler = new StringDebatchHandler(Callback_Debatcher_Test);
            string batch100 = File.ReadAllText("data/hl7v2-batch-1000.hl7");
            HL7v2Debatcher debatcher = new HL7v2Debatcher();
            DebatchResult result = debatcher.Debatch(batch100, options, handler, "1");
        }

        [Benchmark]
        public void BenchmarkStreamingDebatcher1000()
        {
            StringDebatchHandler handler = new StringDebatchHandler(Callback_Debatcher_Test);
            Stream fs = File.OpenRead("data/hl7v2-batch-1000.hl7");
